...
const Playground = () => {
  ...
  return (
    <PlaygroundProvider value={playgroundContextValue}>
      <div className='h-full mt-[60px] px-2 pb-2'>
        <div className='with-pastel-balls rounded-2xl p-1 md:p-2 h-[calc(100vh-66px)]'>
          <Layout className='h-full bg-transparent flex flex-col md:flex-row rounded-xl overflow-hidden'>
