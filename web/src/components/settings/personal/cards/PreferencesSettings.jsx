...
const PreferencesSettings = ({ t }) => {
	...
	return (
		<Card className="!rounded-2xl shadow-sm border-0">
			...
			<Card className="!rounded-xl border border-[var(--glass-border)] bg-[color-mix(in_srgb,var(--glass-bg)_88%,transparent)]">
			...
			{/* Additional info */}
			<div className="mt-4 text-xs text-[var(--semi-color-text-2)]">
