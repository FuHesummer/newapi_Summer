...
const AccountManagement = ({
  ...
  const renderAccountInfo = (accountId, label) => {
    if (!accountId || accountId === '') {
      return <span className='text-[var(--semi-color-text-2)]'>{t('未绑定')}</span>;
    }
    ...
    const popContent = (
      <div className='text-xs p-2'>
        ...
        {label ? (
          <div className='mt-1 text-[11px] text-[var(--semi-color-text-2)]'>{label}</div>
        ) : null}
      </div>
    );
    ...
    <Card className='!rounded-2xl'>
      ...
      <div className='flex items-center mb-4'>
        ...
        <div>
          ...
          <div className='text-xs text-[var(--semi-color-text-1)]'>
            {t('账户绑定、安全设置和身份验证')}
          </div>
        </div>
      </div>
          ...
          <div className='py-4'>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
                ...
                <div className='flex items-center justify-between gap-3'>
                  <div className='flex items-center flex-1 min-w-0'>
                    ...
                    <div className='flex-1 min-w-0'>
                      ...
                      <div className='text-sm text-[var(--semi-color-text-2)] truncate'>
                        {renderAccountInfo(
              ...
              <Modal
                ...
                footer={null}
              >
                <div className='my-3 text-sm text-[var(--semi-color-text-1)]'>
                  ...
                  <div className='flex flex-col sm:flex-row items-start sm:justify-between gap-4'>
                    <div className='flex items-start w-full sm:w-auto'>
                      ...
                      <div>
                        ...
                        <div className='mt-2 text-xs text-[var(--semi-color-text-2)] space-y-1'>
                          <div>
