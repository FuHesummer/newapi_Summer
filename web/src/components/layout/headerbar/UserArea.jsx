        ...
        <Dropdown
          ...
          render={
            <Dropdown.Menu className='!bg-[color-mix(in_srgb,var(--glass-bg)_92%,transparent)] !border-[var(--glass-border)] !shadow-lg !rounded-lg backdrop-blur-md'>
              ...
              <Dropdown.Item
                onClick={logout}
                className='!px-3 !py-1.5 !text-sm !text-[var(--semi-color-text-0)] hover:!bg-[color-mix(in_srgb,var(--glass-bg)_84%,rgba(239,68,68,0.14))]'
              >
                <div className='flex items-center gap-2'>
                  <IconExit
                    size='small'
        ...
        >
          ...
          >
            ...
            <span className='hidden md:inline'>
              <Typography.Text className='!text-xs !font-medium !text-[var(--semi-color-text-1)] mr-1'>
                {userState.user.username}
              </Typography.Text>
            </span>
            <ChevronDown
              size={14}
              className='text-xs text-[var(--semi-color-text-2)]'
            />
          </Button>
        </Dropdown>
      </div>
