        ...
        <div className='px-6 py-4 bg-gradient-to-r from-purple-500 to-blue-500 rounded-t-2xl'>
          <div className='flex items-center justify-between'>
            <div className='flex items-center gap-3'>
              <div className='w-10 h-10 rounded-full bg-[color-mix(in_srgb,var(--glass-bg)_90%,transparent)] backdrop-blur flex items-center justify-center'>
            ...
            <div className='flex items-center gap-2'>
              <Button
                ...
                type='primary'
                size='small'
                className='!rounded-lg !text-white/80 hover:!text-white hover:!bg-[color-mix(in_srgb,var(--glass-bg)_88%,transparent)]'
              >
